    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = _args.length > 1 && _args[1] !== undefined ? _args[1] : {}, _ref2$cwd = _ref2.cwd, cwd = _ref2$cwd === void 0 ? process.cwd() : _ref2$cwd, _ref2$dryRun = _ref2.dryRun, dryRun = _ref2$dryRun === void 0 ? false : _ref2$dryRun, propname = _ref2.propname;
...
function parseConfig(filepath) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      propname = _ref$propname === void 0 ? 'crosslink' : _ref$propname;

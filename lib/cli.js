...
_commander.default.usage('[target]').option('-f, --filename [filename]', 'specify name of definition files', '.crosslink').option('-p, --propname [propname]', 'specify name of property in JSON definitions', 'crosslink').option('-r, --recursive [recursive]', 'scan for definition files recursively', false).option('-d, --dry [dry]', 'perform a dry run and report, do not create symlinks', false).on('--help', function () {
  console.log('');

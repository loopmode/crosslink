...
_commander.default.command('link <definition>').option('-o, --overwrite [overwrite]', 'overwrite existing target', false).option('-d, --dry [dry]', 'perform a dry run and report, do not create symlinks', false).on('--help', function () {
  console.log('');
  console.log('  Arguments:');
  console.log('');

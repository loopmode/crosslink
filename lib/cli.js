...
_commander.default.usage('[target]').option('-f, --filename [filename]', 'specify name of definition files', '.cross-link').option('-p, --propname [propname]', 'specify name of property in JSON definitions', 'cross-link').option('-r, --recursive [recursive]', 'scan for definition files recursively', false).option('-d, --dry [dry]', 'perform a dry run and report, do not create symlinks', false).on('--help', function () {
  console.log('');
...
_commander.default.command('link <definition>').option('-d, --dry [dry]', 'perform a dry run and report, do not create symlinks', false).on('--help', function () {
  console.log('');
  console.log('  Arguments:');
  console.log('');
